          ...
          <MDBNavbarBrand style={{width: '100%', display: 'flex'}}>
            <MDBFormInline className="md-form mb-4" style={{width: '50%'}}>
              ...
              <MDBHamburgerToggler color="#007bff" id="hamburger1" onClick={()=> setCollapse(!collapse)} />
                 <input className="form-control form-control-med ml-3 w-75 border border-primary text-dark" style={{width:'100%'}} type="text" placeholder="Enter PokeName" aria-label="Search" />
                   <MDBCollapse style={{ width: '100'}} isOpen={collapse} navbar>
